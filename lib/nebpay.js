    ...
    3: [
      function(require, module, exports) {
        ...
        window.addEventListener('message', function(resp) {
          console.log(
            'nebpay: received resp.data: ' + JSON.stringify(resp.data)
          )
    ...
    5: [
      function(require, module, exports) {
        ...
        function openApp(params, options) {
          ...
          var url =
            'openapp.NASnano://virtual?params=' + JSON.stringify(appParams)
          ...
          nrc20pay: function(currency, to, value, options) {
            if (options.nrc20 && options.nrc20.decimals > 0) {
              ...
              value = new BigNumber(value)
                .times(new BigNumber(10).pow(options.nrc20.decimals))
                .toString(10)
            }
            var address = ''
